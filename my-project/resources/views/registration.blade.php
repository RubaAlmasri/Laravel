                ...
                <form class="mb-5" method="post" action="">
                    <div class="row" style="padding-left: 10%; padding-right: 10%; padding-top: 5%;">
                        <div class="col-md-12 form-group " >
                            <input type="text" class="form-control" name="name" placeholder="Username" style="border:1px solid; border-radius: 10px;" >
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="email" class="form-control" name="email" placeholder="Email address" style="border:1px solid; border-radius: 10px;">
                        </div>
                        
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" name="phone" placeholder="Password" style="border:1px solid; border-radius: 10px;">
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" name="address" placeholder="Confirm password" style="border:1px solid; border-radius: 10px;">
                        </div>
